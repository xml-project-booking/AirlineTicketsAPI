...
func main() {
	...
	ticketHandlers := handlers.NewTicketsHandler(logger, storeTicket, storeFlight, storeUser)
	...
	createTicketRouter.Use(usersHandler.IsAuthorizedUser)
	...
	getTicketForUserRouter.Use(usersHandler.IsAuthorizedUser)
